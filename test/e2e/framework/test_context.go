...
func RegisterFlags(flags *flag.FlagSet) {
	...
	flags.StringVar(&TestContext.Master, "master", os.Getenv("MASTER"), fmt.Sprintf("The master, or apiserver, to connect to. Will default to MASTER environment or \"\" if this argument and --kubeconfig are not set."))
